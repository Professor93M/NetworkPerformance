  ...
  methods: {
    ...
    dd() {
      ...
      if(this.top10){
        ...
        this.delay10 = (parseFloat(d10) + parseFloat(this.T)).toFixed(2)
        del.push(this.delay10)
      }
      if(this.top11){
        let d11 = ((parseInt(this.dt11) / parseInt(this.S)) * 1000000)
        this.delay11 = (parseFloat(d11) + parseFloat(this.T)).toFixed(2)
        del.push(this.delay11)
      }
      if(this.top12){
        let d12 = ((parseInt(this.dt12) / parseInt(this.S)) * 1000000)
        this.delay12 = (parseFloat(d12) + parseFloat(this.T)).toFixed(2)
